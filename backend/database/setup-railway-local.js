// Railway Database Setup - Local Files Version
// Reads migration files from local filesystem instead of GitHub
...
async function runMigration(client, filename) {
  ...
  try {
    ...
    console.log(`   Read ${(sql.length / 1024).toFixed(1)} KB from local file`);
...
async function setup() {
  ...
  console.log('📁 Using LOCAL migration files\n');
